const BudgetInput = ({ setBudgetModal }) => {
  ...
  return (
    <div className="fixed shadow-lg border top-1/3 left-1/2 -translate-x-1/2 rounded-xl bg-white z-50 px-4 py-4 w-[90%] md:w-1/3">
      <div
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        ...
        <button
          ...
          className="w-full bg-blue_c text-white py-3 rounded-md hover:bg-blue-600 transition duration-200"
        >
          {updateBudgetLoading ? (
